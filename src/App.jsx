  ...
  return (
    <div className="font-roboto text-base text-slate-900 dark:text-white dark:bg-slate-900">
      ...
      <div id="preloader">
        <div id="status">
            <div className="logo">
                <img src="assets/images/logo-icon-64.png" className="d-block mx-auto animate-[spin_10s_linear_infinite]" alt=""/>
            </div>
    ...
    <nav className="navbar" id="navbar">
        <div className="container relative flex flex-wrap items-center justify-between">
            <a className="navbar-brand md:me-8" href="index.html">
                <img src="assets/images/logo-dark.png" className="h-5 inline-block dark:hidden" alt=""/>
                <img src="assets/images/logo-light.png" className="h-5 hidden dark:inline-block" alt=""/>
            </a>
            ...
            <div className="nav-icons flex items-center lg_992:order-2 md:ms-6">
                ...
                <ul className="list-none menu-social mb-0">
                    <li className="inline">
                        <a href="#" className="size-8 inline-flex items-center justify-center rounded-full align-middle bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-white"><i data-feather="user" className="size-4"></i></a>
                    </li>
                    <li className="inline">
                        <a href="#" className="h-8 px-4 text-[12px] tracking-wider inline-flex items-center justify-center font-medium rounded-full bg-red-500 text-white uppercase">Signup</a>
                    </li>
                </ul>

                <button data-collapse="menu-collapse" type="button" className="collapse-btn inline-flex items-center ms-2 text-slate-900 dark:text-white lg_992:hidden" aria-controls="menu-collapse" aria-expanded="false">
            ...
            <div className="navigation lg_992:order-1 lg_992:flex hidden ms-auto" id="menu-collapse">
                <ul className="navbar-nav" id="navbar-navlist">
                    ...
                    <li className="nav-item">
                        <a className="nav-link" href="#screenshot">Application</a>
                    </li>
                    <li className="nav-item">
    ...
    <section className="relative overflow-hidden md:py-36 py-24 bg-slate-50/50 dark:bg-slate-800/20 bg-[url('../../assets/images/bg1.html')] bg-no-repeat bg-center bg-cover" id="home">
        <div className="container relative">
            <div className="grid md:grid-cols-2 grid-cols-1 items-center mt-6 gap-[30px] relative">
                <div className="md:me-6">
                    ...
                    <div className="mt-6">
                        <a href="#"><img src="assets/images/app.png" className="h-12 inline-block m-1" alt=""/></a>
                        <a href="#"><img src="assets/images/play.png" className="h-12 inline-block m-1" alt=""/></a>
                    </div>
                </div>

                <div className="relative">
                    <img src="assets/images/phone/1.png" className="mx-auto w-80 rotate-12 relative z-2" alt=""/>
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-6 gap-6">
                <div className="p-6 hover:shadow-xl hover:shadow-slate-100 dark:hover:shadow-slate-800 transition duration-500 rounded-3xl">
                    ...
                    <div className="content mt-7">
                        <a href="#" className="text-lg hover:text-red-500 dark:text-white dark:hover:text-red-500 transition-all duration-500 ease-in-out font-semibold">Fully functional</a>
                        <p className="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                        
                        <div className="mt-3">
                            <a href="#" className="hover:text-red-500 dark:hover:text-red-500 after:bg-red-500 dark:text-white transition duration-500">Read More <i className="mdi mdi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-6 shadow-xl shadow-slate-100 dark:shadow-slate-800 transition duration-500 rounded-3xl">
                    ...
                    <div className="content mt-7">
                        <a href="#" className="text-lg hover:text-red-500 dark:text-white dark:hover:text-red-500 transition-all duration-500 ease-in-out font-semibold">Secure Data</a>
                        <p className="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                ...
                <div className="p-6 hover:shadow-xl hover:shadow-slate-100 dark:hover:shadow-slate-800 transition duration-500 rounded-3xl">
                    ...
                    <div className="content mt-7">
                        <a href="#" className="text-lg hover:text-red-500 dark:text-white dark:hover:text-red-500 transition-all duration-500 ease-in-out font-semibold">Track Location</a>
                        <p className="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                ...
                <div className="p-6 shadow-xl shadow-slate-100 dark:shadow-slate-800 transition duration-500 rounded-3xl">
                    ...
                    <div className="content mt-7">
                        <a href="#" className="text-lg hover:text-red-500 dark:text-white dark:hover:text-red-500 transition-all duration-500 ease-in-out font-semibold">Data Analyse</a>
                        <p className="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
            ...
            <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-6">
                ...
                <div className="lg:col-span-7 md:col-span-6">
                    <div className="lg:ms-10">
                        ...
                        <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-6">
                            <div className="group flex relative overflow-hidden p-6 rounded-md shadow dark:shadow-gray-800 bg-slate-50/50 dark:bg-slate-800/20 hover:bg-red-500 dark:hover:bg-red-500 duration-500">
                                ...
                                <div className="flex-1 ms-3">
                                    <h5 className="group-hover:text-white text-lg font-semibold duration-500">Enhance Security</h5>
                                    <p className="text-slate-400 group-hover:text-white/50 duration-500 mt-2">There are many variations of passages of Lorem Ipsum available</p>
                                </div>
                            ...
                            <div className="group flex relative overflow-hidden p-6 rounded-md shadow dark:shadow-gray-800 bg-slate-50/50 dark:bg-slate-800/20 hover:bg-red-500 dark:hover:bg-red-500 duration-500">
                                ...
                                <div className="flex-1 ms-3">
                                    <h5 className="group-hover:text-white text-lg font-semibold duration-500">High Performance</h5>
                                    <p className="text-slate-400 group-hover:text-white/50 duration-500 mt-2">There are many variations of passages of Lorem Ipsum available</p>
                                </div>
                                <div className="absolute start-1 top-5 text-slate-900/[0.02] dark:text-white/[0.03] text-8xl group-hover:text-white/[0.1] duration-500">
                        ...
                        <div className="mt-6">
                            <a href="#" className="hover:text-red-500 dark:hover:text-red-500 after:bg-red-500 dark:text-white transition duration-500 font-medium">Learn More <i className="mdi mdi-arrow-right align-middle"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 mt-6 relative">
                <div className="tiny-four-item">
                    <div className="tiny-slide">
                        <a href="assets/images/phone/1.png" className="lightbox"><img src="assets/images/phone/1.png" alt=""/></a>
                    </div>
                    
                    <div className="tiny-slide">
                        <a href="assets/images/phone/2.png" className="lightbox"><img src="assets/images/phone/2.png" alt=""/></a>
                    </div>
                    
                    <div className="tiny-slide">
                        <a href="assets/images/phone/3.png" className="lightbox"><img src="assets/images/phone/3.png" alt=""/></a>
                    </div>
                    
                    <div className="tiny-slide">
                        <a href="assets/images/phone/4.png" className="lightbox"><img src="assets/images/phone/4.png" alt=""/></a>
                    </div>
                    
                    <div className="tiny-slide">
                        <a href="assets/images/phone/5.png" className="lightbox"><img src="assets/images/phone/5.png" alt=""/></a>
                    </div>
                    
                    <div className="tiny-slide">
                        <a href="assets/images/phone/6.png" className="lightbox"><img src="assets/images/phone/6.png" alt=""/></a>
                    </div>
                    
                    <div className="tiny-slide">
                        <a href="assets/images/phone/7.png" className="lightbox"><img src="assets/images/phone/7.png" alt=""/></a>
                    </div>
                    
                    <div className="tiny-slide">
                        <a href="assets/images/phone/8.png" className="lightbox"><img src="assets/images/phone/8.png" alt=""/></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="container relative">
            <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                <div className="relative order-1 md:order-2">
                    <div className="relative">
                        <img src="assets/images/phone/3.png" className="mx-auto md:max-w-xs lg:max-w-sm" alt=""/>
                    ...
                    <div className="absolute bottom-28 md:start-0 -start-5 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 w-52 m-3">
                        <div className="flex items-center">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xl font-bold"><span className="counter-value" data-target="45485">39548</span></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:me-8 order-2 md:order-1">
                    ...
                    <div id="accordion-collapseone" data-accordion="collapse" className="mt-8">
                        <div className="relative shadow dark:shadow-gray-800 rounded-md overflow-hidden">
                            <h2 className="font-semibold" id="accordion-collapse-heading-1">
                        ...
                        <div className="relative shadow dark:shadow-gray-800 rounded-md overflow-hidden mt-4">
                            <h2 className="text-lg font-semibold" id="accordion-collapse-heading-2">
                        ...
                        <div className="relative shadow dark:shadow-gray-800 rounded-md overflow-hidden mt-4">
                            <h2 className="text-lg font-semibold" id="accordion-collapse-heading-3">
                        ...
                        <div className="relative shadow dark:shadow-gray-800 rounded-md overflow-hidden mt-4">
                            <h2 className="text-lg font-semibold" id="accordion-collapse-heading-4">
                    ...
                    <div className="mt-6">
                        <a href="#" className="hover:text-red-500 dark:hover:text-red-500 after:bg-red-500 dark:text-white transition duration-500 font-medium">Find Out More <i className="mdi mdi-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div className="lg:ms-10">
                        ...
                        <div className="inline-block">
                            <div className="pt-4 flex items-center border-t border-gray-100 dark:border-gray-800">
                                <i data-feather="smartphone" className="me-2 text-red-500 size-10"></i>
                                <div className="content">
                                    <h6 className="text-base font-medium">Install app now on your cellphones</h6>
                                    <a href="#" className="hover:text-red-500 dark:hover:text-red-500 after:bg-red-500 dark:text-white transition duration-500 font-medium">Install Now <i className="mdi mdi-arrow-right"></i></a> 
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="tiny-three-item">
                    <div className="tiny-slide text-center">
                        <div className="cursor-e-resize">
                            ...
                            <div className="text-center mt-5">
                                <img src="assets/images/client/01.jpg" className="size-14 rounded-full shadow-md mx-auto" alt=""/>
                    ...
                    <div className="tiny-slide text-center">
                        <div className="cursor-e-resize">
                            ...
                            <div className="text-center mt-5">
                                <img src="assets/images/client/02.jpg" className="size-14 rounded-full shadow-md mx-auto" alt=""/>
                    ...
                    <div className="tiny-slide text-center">
                        <div className="cursor-e-resize">
                            ...
                            <div className="text-center mt-5">
                                <img src="assets/images/client/03.jpg" className="size-14 rounded-full shadow-md mx-auto" alt=""/>
                    ...
                    <div className="tiny-slide text-center">
                        <div className="cursor-e-resize">
                            ...
                            <div className="text-center mt-5">
                                <img src="assets/images/client/04.jpg" className="size-14 rounded-full shadow-md mx-auto" alt=""/>
                    ...
                    <div className="tiny-slide text-center">
                        <div className="cursor-e-resize">
                            ...
                            <div className="text-center mt-5">
                                <img src="assets/images/client/05.jpg" className="size-14 rounded-full shadow-md mx-auto" alt=""/>
                    ...
                    <div className="tiny-slide text-center">
                        <div className="cursor-e-resize">
                            ...
                            <div className="text-center mt-5">
                                <img src="assets/images/client/06.jpg" className="size-14 rounded-full shadow-md mx-auto" alt=""/>
                                <h6 className="mt-2 font-semibold">Cristino Murfi</h6>
                                <span className="text-slate-400 text-sm">Manager</span>
                            </div>
                        </div>
    ...
    <a href="#" onclick="topFunction()" id="back-to-top" className="back-to-top fixed hidden text-lg rounded-full z-10 bottom-5 end-5 h-9 w-9 text-center bg-red-500 text-white leading-9"><i className="mdi mdi-arrow-up"></i></a>
